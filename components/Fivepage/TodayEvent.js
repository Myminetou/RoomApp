...
export default function TodayEvent() {
    return (
        <View>
            <Text style={{ fontSize : 20, color:"black", margin:30, marginTop:30}}>What do you need to do? สิ่งที่คุณต้องทำ</Text>
            <Text style={{ fontSize : 15, color:"red", marginLeft:20}}>Today</Text>
